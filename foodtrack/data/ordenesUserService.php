<?php
	...
	else
	{
			...
			$dateT = date("j F Y, g:i a");

			$sql = "INSERT INTO comida (dateT, nombreRestaurante, emailRestaurante, tomate, cebolla, aguacate, cilantro, pina, lechuga, papa, chile, apio, zanahoria, comentarios) VALUES ('$dateT','$userActual', '$email' ,'$tomate', '$cebolla','$aguacate', '$cilantro', '$pina', '$lechuga', '$papas', '$chile', '$apio', '$zanahoria', '$comentarios')";
